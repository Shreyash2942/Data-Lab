...
| Stack | Path | Example |
|---|---|---|
| Airflow | `stacks/airflow` | `stacks/airflow/dags/data_lab_stack_validation.py` |
| Spark | `stacks/spark` | `stacks/spark/example_pyspark.py` |
| Kafka | `stacks/kafka` | `stacks/kafka/demo.sh` |
| Hive | `stacks/hive` | `stacks/hive/bootstrap_demo.sh` |
| Hadoop | `stacks/hadoop` | `stacks/hadoop/scripts/hdfs_check.sh` |
| dbt | `stacks/dbt` | `stacks/dbt/models/example_model.sql` |
...
| Terraform | `stacks/terraform` | `stacks/terraform/main.tf` |
