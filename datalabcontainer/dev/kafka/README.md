...
- `server.properties` — broker configuration (PLAINTEXT listener on `localhost:9092`, logs under `~/runtime/kafka/logs`)
- `zookeeper.properties` — Zookeeper data directory configuration (`~/runtime/kafka/zookeeper-data`)
