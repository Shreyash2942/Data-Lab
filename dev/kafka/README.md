...
- `server.properties` — broker configuration (PLAINTEXT listener on `localhost:9092`, logs under `~/kafka/logs`)
- `zookeeper.properties` — Zookeeper data directory configuration (`~/kafka/zookeeper-data`)
